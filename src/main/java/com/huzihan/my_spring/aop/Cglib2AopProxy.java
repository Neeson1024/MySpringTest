    ...
    private static class DynamicAdvisedInterceptor implements MethodInterceptor {
        ...
        public Object intercept(Object obj, Method method, Object[] args, MethodProxy proxy) throws Throwable {
            ...
            if (advised.getMethodMatcher() == null
                ...
                return delegateMethodInterceptor.invoke(new CglibMethodInvocation(advised.getTargetSource().getTarge(), method, args, proxy));
            }
            // 有AspectJ表达式，但没有匹配该方法，返回通过methodProxy调用原始对象的该方法
            return new CglibMethodInvocation(advised.getTargetSource().getTarge(), method, args, proxy).proceed();
        }
    }
